...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'auth.providers.tenants.driver' => 'string',
            'auth.providers.tenants.model' => 'string',
            ...
            'filament.panels.tenant.id' => 'string',
            'filament.panels.tenant.auth.guard' => 'string',
            'filament.panels.tenant.auth.pages.login' => 'string',
            'filament.multi_panel' => 'boolean',
            ...
            'filament-shield.tenant_model' => 'string',
            ...
            'filament-shield.register_permission_for_all_resources' => 'boolean',
            'filament-shield.auto_discover_resources' => 'boolean',
            ...
            'filesystems.links./home/vagrant/crm/public/storage' => 'string',
            ...
            'multitenancy1.tenant_finder' => 'string',
            'multitenancy1.tenant_artisan_search_fields' => 'array',
            'multitenancy1.switch_tenant_tasks' => 'array',
            'multitenancy1.tenant_model' => 'string',
            'multitenancy1.queues_are_tenant_aware_by_default' => 'boolean',
            'multitenancy1.tenant_database_connection_name' => 'string',
            'multitenancy1.landlord_database_connection_name' => 'string',
            'multitenancy1.current_tenant_context_key' => 'string',
            'multitenancy1.current_tenant_container_key' => 'string',
            'multitenancy1.shared_routes_cache' => 'boolean',
            'multitenancy1.actions.make_tenant_current_action' => 'string',
            'multitenancy1.actions.forget_current_tenant_action' => 'string',
            'multitenancy1.actions.make_queue_tenant_aware_action' => 'string',
            'multitenancy1.actions.migrate_tenant' => 'string',
            'multitenancy1.queueable_to_job.Illuminate\Mail\SendQueuedMailable' => 'string',
            'multitenancy1.queueable_to_job.Illuminate\Notifications\SendQueuedNotifications' => 'string',
            'multitenancy1.queueable_to_job.Illuminate\Queue\CallQueuedClosure' => 'string',
            'multitenancy1.queueable_to_job.Illuminate\Events\CallQueuedListener' => 'string',
            'multitenancy1.queueable_to_job.Illuminate\Broadcasting\BroadcastEvent' => 'string',
            'multitenancy1.tenant_aware_jobs' => 'array',
            'multitenancy1.not_tenant_aware_jobs' => 'array',
...
'auth.guards.tenant.driver','auth.guards.tenant.provider','auth.providers.users.driver','auth.providers.users.model','auth.providers.tenants.driver',
'auth.providers.tenants.model','auth.passwords.users.provider','auth.passwords.users.table','auth.passwords.users.expire','auth.passwords.users.throttle',
...
'database.connections.sqlsrv.prefix_indexes','database.connections.tenant.driver','database.connections.tenant.host','database.connections.tenant.port','database.connections.tenant.database',
...
'database.redis.cache.password','database.redis.cache.port','database.redis.cache.database','filament.broadcasting','filament.default_filesystem_disk',
'filament.assets_path','filament.cache_path','filament.livewire_loading_delay','filament.panels.tenant.id','filament.panels.tenant.auth.guard',
'filament.panels.tenant.auth.pages.login','filament.multi_panel','filament-shield.shield_resource.should_register_navigation','filament-shield.shield_resource.slug','filament-shield.shield_resource.navigation_sort',
...
'filament-shield.discovery.discover_all_pages','filament-shield.register_role_policy.enabled','filament-shield.register_permission_for_all_resources','filament-shield.auto_discover_resources','filesystems.default',
...
'filesystems.disks.s3.report','filesystems.links./home/vagrant/crm/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'multitenancy.queueable_to_job.Illuminate\\Broadcasting\\BroadcastEvent','multitenancy.tenant_aware_jobs','multitenancy.not_tenant_aware_jobs','multitenancy1.tenant_finder','multitenancy1.tenant_artisan_search_fields',
'multitenancy1.switch_tenant_tasks','multitenancy1.tenant_model','multitenancy1.queues_are_tenant_aware_by_default','multitenancy1.tenant_database_connection_name','multitenancy1.landlord_database_connection_name',
'multitenancy1.current_tenant_context_key','multitenancy1.current_tenant_container_key','multitenancy1.shared_routes_cache','multitenancy1.actions.make_tenant_current_action','multitenancy1.actions.forget_current_tenant_action',
'multitenancy1.actions.make_queue_tenant_aware_action','multitenancy1.actions.migrate_tenant','multitenancy1.queueable_to_job.Illuminate\\Mail\\SendQueuedMailable','multitenancy1.queueable_to_job.Illuminate\\Notifications\\SendQueuedNotifications','multitenancy1.queueable_to_job.Illuminate\\Queue\\CallQueuedClosure',
'multitenancy1.queueable_to_job.Illuminate\\Events\\CallQueuedListener','multitenancy1.queueable_to_job.Illuminate\\Broadcasting\\BroadcastEvent','multitenancy1.tenant_aware_jobs','multitenancy1.not_tenant_aware_jobs','permission.models.permission',
...
'permission.cache.key','permission.cache.store','permission.defaults.guard','permission.guards','queue.default',
...
'filament.exports.download','filament.imports.failed-rows.download','filament.admin.auth.login','filament.admin.auth.logout','filament.admin.home',
'filament.admin.pages.company-config','filament.admin.pages.follow-up-config','filament.admin.pages.item-config','filament.admin.pages.lead-config','filament.admin.pages.sales-marketing-config',
'filament.admin.pages.dashboard','filament.admin.resources.account-masters.index','filament.admin.resources.account-masters.create','filament.admin.resources.account-masters.edit','filament.admin.resources.address-types.index',
'filament.admin.resources.address-types.create','filament.admin.resources.address-types.edit','filament.admin.resources.attachments.index','filament.admin.resources.attachments.create','filament.admin.resources.attachments.edit',
'filament.admin.resources.categories.index','filament.admin.resources.categories.create','filament.admin.resources.categories.edit','filament.admin.resources.city-pin-codes.index','filament.admin.resources.city-pin-codes.create',
'filament.admin.resources.city-pin-codes.edit','filament.admin.resources.cities.index','filament.admin.resources.cities.create','filament.admin.resources.cities.edit','filament.admin.resources.company-master-bank-details.index',
'filament.admin.resources.company-master-bank-details.create','filament.admin.resources.company-master-bank-details.edit','filament.admin.resources.company-masters.index','filament.admin.resources.company-masters.create','filament.admin.resources.company-masters.edit',
'filament.admin.resources.company-master-statutory-details.index','filament.admin.resources.company-master-statutory-details.create','filament.admin.resources.company-master-statutory-details.edit','filament.admin.resources.company-master-types.index','filament.admin.resources.company-master-types.create',
'filament.admin.resources.company-master-types.edit','filament.admin.resources.companies.index','filament.admin.resources.companies.create','filament.admin.resources.companies.edit','filament.admin.resources.contact-details.index',
'filament.admin.resources.contact-details.create','filament.admin.resources.contact-details.edit','filament.admin.resources.countries.index','filament.admin.resources.countries.create','filament.admin.resources.countries.edit',
'filament.admin.resources.deals.index','filament.admin.resources.deals.create','filament.admin.resources.deals.edit','filament.admin.resources.departments.index','filament.admin.resources.departments.create',
'filament.admin.resources.departments.edit','filament.admin.resources.designations.index','filament.admin.resources.designations.create','filament.admin.resources.designations.edit','filament.admin.resources.expense-configurations.index',
'filament.admin.resources.expense-configurations.create','filament.admin.resources.expense-configurations.edit','filament.admin.resources.expense-types.index','filament.admin.resources.expense-types.create','filament.admin.resources.expense-types.edit',
'filament.admin.resources.follow-up-media.index','filament.admin.resources.follow-up-media.create','filament.admin.resources.follow-up-media.edit','filament.admin.resources.follow-up-priorities.index','filament.admin.resources.follow-up-priorities.create',
'filament.admin.resources.follow-up-priorities.edit','filament.admin.resources.follow-ups.index','filament.admin.resources.follow-ups.create','filament.admin.resources.follow-ups.edit','filament.admin.resources.follow-up-results.index',
'filament.admin.resources.follow-up-results.create','filament.admin.resources.follow-up-results.edit','filament.admin.resources.follow-up-statuses.index','filament.admin.resources.follow-up-statuses.create','filament.admin.resources.follow-up-statuses.edit',
'filament.admin.resources.gst-pans.index','filament.admin.resources.gst-pans.create','filament.admin.resources.gst-pans.edit','filament.admin.resources.images.index','filament.admin.resources.images.create',
'filament.admin.resources.images.edit','filament.admin.resources.industry-types.index','filament.admin.resources.industry-types.create','filament.admin.resources.industry-types.edit','filament.admin.resources.item-brands.index',
'filament.admin.resources.item-brands.create','filament.admin.resources.item-brands.edit','filament.admin.resources.item-masters.index','filament.admin.resources.item-masters.create','filament.admin.resources.item-masters.edit',
'filament.admin.resources.item-measurement-units.index','filament.admin.resources.item-measurement-units.create','filament.admin.resources.item-measurement-units.edit','filament.admin.resources.lead-activities.index','filament.admin.resources.lead-activities.create',
'filament.admin.resources.lead-activities.edit','filament.admin.resources.lead-custom-fields.index','filament.admin.resources.lead-custom-fields.create','filament.admin.resources.lead-custom-fields.edit','filament.admin.resources.leads.index',
'filament.admin.resources.leads.create','filament.admin.resources.leads.edit','filament.admin.resources.leads.custom-fields','filament.admin.resources.lead-sources.index','filament.admin.resources.lead-sources.create',
'filament.admin.resources.lead-sources.edit','filament.admin.resources.lead-statuses.index','filament.admin.resources.lead-statuses.create','filament.admin.resources.lead-statuses.edit','filament.admin.resources.location-masters.index',
'filament.admin.resources.location-masters.create','filament.admin.resources.location-masters.edit','filament.admin.resources.location-masters.view','filament.admin.resources.number-series.index','filament.admin.resources.number-series.create',
'filament.admin.resources.number-series.edit','filament.admin.resources.packaging-types.index','filament.admin.resources.packaging-types.create','filament.admin.resources.packaging-types.edit','filament.admin.resources.permissions.index',
'filament.admin.resources.permissions.create','filament.admin.resources.permissions.edit','filament.admin.resources.quotes.index','filament.admin.resources.quotes.create','filament.admin.resources.quotes.edit',
'filament.admin.resources.rating-types.index','filament.admin.resources.rating-types.create','filament.admin.resources.rating-types.edit','filament.admin.resources.regions.index','filament.admin.resources.regions.create',
'filament.admin.resources.regions.edit','filament.admin.resources.roles.index','filament.admin.resources.roles.create','filament.admin.resources.roles.edit','filament.admin.resources.sales-daily-expenses.index',
'filament.admin.resources.sales-daily-expenses.create','filament.admin.resources.sales-daily-expenses.edit','filament.admin.resources.sales-dcrs.index','filament.admin.resources.sales-dcrs.create','filament.admin.resources.sales-dcrs.edit',
'filament.admin.resources.sales-invoices.index','filament.admin.resources.sales-invoices.create','filament.admin.resources.sales-invoices.edit','filament.admin.resources.sales-orders.index','filament.admin.resources.sales-orders.create',
'filament.admin.resources.sales-orders.edit','filament.admin.resources.states.index','filament.admin.resources.states.create','filament.admin.resources.states.edit','filament.admin.resources.tenants.index',
'filament.admin.resources.tenants.create','filament.admin.resources.tenants.edit','filament.admin.resources.tenant-users.index','filament.admin.resources.tenant-users.create','filament.admin.resources.tenant-users.edit',
'filament.admin.resources.terms-and-conditions.index','filament.admin.resources.terms-and-conditions.create','filament.admin.resources.terms-and-conditions.edit','filament.admin.resources.terms-types.index','filament.admin.resources.terms-types.create',
'filament.admin.resources.terms-types.edit','filament.admin.resources.tour-plans.index','filament.admin.resources.tour-plans.create','filament.admin.resources.tour-plans.edit','filament.admin.resources.transport-modes.index',
'filament.admin.resources.transport-modes.create','filament.admin.resources.transport-modes.edit','filament.admin.resources.type-masters.index','filament.admin.resources.type-masters.create','filament.admin.resources.type-masters.edit',
'filament.admin.resources.unit-of-measurements.index','filament.admin.resources.unit-of-measurements.create','filament.admin.resources.unit-of-measurements.edit','filament.admin.resources.users.index','filament.admin.resources.users.create',
'filament.admin.resources.users.edit','filament.admin.resources.visit-purposes.index','filament.admin.resources.visit-purposes.create','filament.admin.resources.visit-purposes.edit','filament.admin.resources.visit-routes.index',
'filament.admin.resources.visit-routes.create','filament.admin.resources.visit-routes.edit','filament.admin.resources.visit-route-tour-plans.index','filament.admin.resources.visit-route-tour-plans.create','filament.admin.resources.visit-route-tour-plans.edit',
'filament.admin.resources.visit-types.index','filament.admin.resources.visit-types.create','filament.admin.resources.visit-types.edit','filament.landlord.auth.login','filament.landlord.auth.logout',
'filament.landlord.home','filament.landlord.pages.dashboard','filament.tenant.pages.dashboard','filament.tenant.auth.logout','filament.tenant.filament.tenant.auth.login',
'filament.tenant.auth.login','filament.tenant.home','filament.tenant.pages.company-config','filament.tenant.pages.follow-up-config','filament.tenant.pages.item-config',
'filament.tenant.pages.lead-config','filament.tenant.pages.sales-marketing-config','filament.tenant.resources.account-masters.index','filament.tenant.resources.account-masters.create','filament.tenant.resources.account-masters.edit',
'filament.tenant.resources.address-types.index','filament.tenant.resources.address-types.create','filament.tenant.resources.address-types.edit','filament.tenant.resources.attachments.index','filament.tenant.resources.attachments.create',
'filament.tenant.resources.attachments.edit','filament.tenant.resources.categories.index','filament.tenant.resources.categories.create','filament.tenant.resources.categories.edit','filament.tenant.resources.city-pin-codes.index',
'filament.tenant.resources.city-pin-codes.create','filament.tenant.resources.city-pin-codes.edit','filament.tenant.resources.cities.index','filament.tenant.resources.cities.create','filament.tenant.resources.cities.edit',
'filament.tenant.resources.company-master-bank-details.index','filament.tenant.resources.company-master-bank-details.create','filament.tenant.resources.company-master-bank-details.edit','filament.tenant.resources.company-masters.index','filament.tenant.resources.company-masters.create',
'filament.tenant.resources.company-masters.edit','filament.tenant.resources.company-master-statutory-details.index','filament.tenant.resources.company-master-statutory-details.create','filament.tenant.resources.company-master-statutory-details.edit','filament.tenant.resources.company-master-types.index',
'filament.tenant.resources.company-master-types.create','filament.tenant.resources.company-master-types.edit','filament.tenant.resources.companies.index','filament.tenant.resources.companies.create','filament.tenant.resources.companies.edit',
'filament.tenant.resources.contact-details.index','filament.tenant.resources.contact-details.create','filament.tenant.resources.contact-details.edit','filament.tenant.resources.countries.index','filament.tenant.resources.countries.create',
'filament.tenant.resources.countries.edit','filament.tenant.resources.deals.index','filament.tenant.resources.deals.create','filament.tenant.resources.deals.edit','filament.tenant.resources.departments.index',
'filament.tenant.resources.departments.create','filament.tenant.resources.departments.edit','filament.tenant.resources.designations.index','filament.tenant.resources.designations.create','filament.tenant.resources.designations.edit',
'filament.tenant.resources.expense-configurations.index','filament.tenant.resources.expense-configurations.create','filament.tenant.resources.expense-configurations.edit','filament.tenant.resources.expense-types.index','filament.tenant.resources.expense-types.create',
'filament.tenant.resources.expense-types.edit','filament.tenant.resources.follow-up-media.index','filament.tenant.resources.follow-up-media.create','filament.tenant.resources.follow-up-media.edit','filament.tenant.resources.follow-up-priorities.index',
'filament.tenant.resources.follow-up-priorities.create','filament.tenant.resources.follow-up-priorities.edit','filament.tenant.resources.follow-ups.index','filament.tenant.resources.follow-ups.create','filament.tenant.resources.follow-ups.edit',
'filament.tenant.resources.follow-up-results.index','filament.tenant.resources.follow-up-results.create','filament.tenant.resources.follow-up-results.edit','filament.tenant.resources.follow-up-statuses.index','filament.tenant.resources.follow-up-statuses.create',
'filament.tenant.resources.follow-up-statuses.edit','filament.tenant.resources.gst-pans.index','filament.tenant.resources.gst-pans.create','filament.tenant.resources.gst-pans.edit','filament.tenant.resources.images.index',
'filament.tenant.resources.images.create','filament.tenant.resources.images.edit','filament.tenant.resources.industry-types.index','filament.tenant.resources.industry-types.create','filament.tenant.resources.industry-types.edit',
'filament.tenant.resources.item-brands.index','filament.tenant.resources.item-brands.create','filament.tenant.resources.item-brands.edit','filament.tenant.resources.item-masters.index','filament.tenant.resources.item-masters.create',
'filament.tenant.resources.item-masters.edit','filament.tenant.resources.item-measurement-units.index','filament.tenant.resources.item-measurement-units.create','filament.tenant.resources.item-measurement-units.edit','filament.tenant.resources.lead-activities.index',
'filament.tenant.resources.lead-activities.create','filament.tenant.resources.lead-activities.edit','filament.tenant.resources.lead-custom-fields.index','filament.tenant.resources.lead-custom-fields.create','filament.tenant.resources.lead-custom-fields.edit',
'filament.tenant.resources.leads.index','filament.tenant.resources.leads.create','filament.tenant.resources.leads.edit','filament.tenant.resources.leads.custom-fields','filament.tenant.resources.lead-sources.index',
'filament.tenant.resources.lead-sources.create','filament.tenant.resources.lead-sources.edit','filament.tenant.resources.lead-statuses.index','filament.tenant.resources.lead-statuses.create','filament.tenant.resources.lead-statuses.edit',
'filament.tenant.resources.location-masters.index','filament.tenant.resources.location-masters.create','filament.tenant.resources.location-masters.edit','filament.tenant.resources.location-masters.view','filament.tenant.resources.number-series.index',
'filament.tenant.resources.number-series.create','filament.tenant.resources.number-series.edit','filament.tenant.resources.packaging-types.index','filament.tenant.resources.packaging-types.create','filament.tenant.resources.packaging-types.edit',
'filament.tenant.resources.permissions.index','filament.tenant.resources.permissions.create','filament.tenant.resources.permissions.edit','filament.tenant.resources.quotes.index','filament.tenant.resources.quotes.create',
'filament.tenant.resources.quotes.edit','filament.tenant.resources.rating-types.index','filament.tenant.resources.rating-types.create','filament.tenant.resources.rating-types.edit','filament.tenant.resources.regions.index',
'filament.tenant.resources.regions.create','filament.tenant.resources.regions.edit','filament.tenant.resources.roles.index','filament.tenant.resources.roles.create','filament.tenant.resources.roles.edit',
'filament.tenant.resources.sales-daily-expenses.index','filament.tenant.resources.sales-daily-expenses.create','filament.tenant.resources.sales-daily-expenses.edit','filament.tenant.resources.sales-dcrs.index','filament.tenant.resources.sales-dcrs.create',
'filament.tenant.resources.sales-dcrs.edit','filament.tenant.resources.sales-invoices.index','filament.tenant.resources.sales-invoices.create','filament.tenant.resources.sales-invoices.edit','filament.tenant.resources.sales-orders.index',
'filament.tenant.resources.sales-orders.create','filament.tenant.resources.sales-orders.edit','filament.tenant.resources.states.index','filament.tenant.resources.states.create','filament.tenant.resources.states.edit',
'filament.tenant.resources.tenants.index','filament.tenant.resources.tenants.create','filament.tenant.resources.tenants.edit','filament.tenant.resources.tenant-users.index','filament.tenant.resources.tenant-users.create',
'filament.tenant.resources.tenant-users.edit','filament.tenant.resources.terms-and-conditions.index','filament.tenant.resources.terms-and-conditions.create','filament.tenant.resources.terms-and-conditions.edit','filament.tenant.resources.terms-types.index',
'filament.tenant.resources.terms-types.create','filament.tenant.resources.terms-types.edit','filament.tenant.resources.tour-plans.index','filament.tenant.resources.tour-plans.create','filament.tenant.resources.tour-plans.edit',
'filament.tenant.resources.transport-modes.index','filament.tenant.resources.transport-modes.create','filament.tenant.resources.transport-modes.edit','filament.tenant.resources.type-masters.index','filament.tenant.resources.type-masters.create',
'filament.tenant.resources.type-masters.edit','filament.tenant.resources.unit-of-measurements.index','filament.tenant.resources.unit-of-measurements.create','filament.tenant.resources.unit-of-measurements.edit','filament.tenant.resources.users.index',
'filament.tenant.resources.users.create','filament.tenant.resources.users.edit','filament.tenant.resources.visit-purposes.index','filament.tenant.resources.visit-purposes.create','filament.tenant.resources.visit-purposes.edit',
'filament.tenant.resources.visit-routes.index','filament.tenant.resources.visit-routes.create','filament.tenant.resources.visit-routes.edit','filament.tenant.resources.visit-route-tour-plans.index','filament.tenant.resources.visit-route-tour-plans.create',
'filament.tenant.resources.visit-route-tour-plans.edit','filament.tenant.resources.visit-types.index','filament.tenant.resources.visit-types.create','filament.tenant.resources.visit-types.edit','livewire.update','livewire.upload-file','livewire.preview-file',
'tenant.dashboard','storage.local',);
        registerArgumentsSet('views', 
'components.lead-context-menu','filament.components.custom-sidebar','filament.components.edit-contact','filament.components.menu-search','filament.filament-panels.custom-styles',
'filament.landlord.pages.landlord-dashboard','filament.pages.admin-dashboard','filament.pages.company-config','filament.pages.dashboard','filament.pages.follow-up-config',
'filament.pages.item-config','filament.pages.lead-config','filament.pages.quick-links-sidebar','filament.pages.sales-marketing-config','filament.pages.tenant-dashboard',
'filament.resources.lead-resource.pages.custom-fields','filament.sidebars.city-pin-codes-sidebar','filament.sidebars.dashboard-sidebar','filament.widgets.current-database','welcome',
...
'validation.uuid','validation.custom.attribute-name.rule-name','table-repeater::components.repeater.empty.label','table-repeater::components.repeater.row_actions.label','filament-shield::filament-shield.column.name',
...
'DB_PASSWORD','MULTITENANCY_LANDLORD_DB_CONNECTION','MULTITENANCY_TENANT_DB_CONNECTION','SESSION_DRIVER','SESSION_LIFETIME',
...
'AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','QUEUE_CONNECTION',);
