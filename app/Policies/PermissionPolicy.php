...
class PermissionPolicy
{
     ...
     */
    public function view(User|TenantUser $user, Permission $permission): bool
    {
     ...
     */
    public function update(User|TenantUser $user, Permission $permission): bool
    {
     ...
     */
    public function delete(User|TenantUser $user, Permission $permission): bool
    {
     ...
     */
    public function forceDelete(User|TenantUser $user, Permission $permission): bool
    {
     ...
     */
    public function restore(User|TenantUser $user, Permission $permission): bool
    {
     ...
     */
    public function replicate(User|TenantUser $user, Permission $permission): bool
    {
