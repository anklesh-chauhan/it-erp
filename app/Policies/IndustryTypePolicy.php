...
class IndustryTypePolicy
{
     ...
     */
    public function view(User|TenantUser $user, IndustryType $industryType): bool
    {
     ...
     */
    public function update(User|TenantUser $user, IndustryType $industryType): bool
    {
     ...
     */
    public function delete(User|TenantUser $user, IndustryType $industryType): bool
    {
     ...
     */
    public function forceDelete(User|TenantUser $user, IndustryType $industryType): bool
    {
     ...
     */
    public function restore(User|TenantUser $user, IndustryType $industryType): bool
    {
     ...
     */
    public function replicate(User|TenantUser $user, IndustryType $industryType): bool
    {
