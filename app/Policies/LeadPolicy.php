...
class LeadPolicy
{
    ...
    public function viewOwnTerritory(AuthUser $authUser, Lead $lead): bool
    {
        return $authUser->can('ViewOwnTerritory:Lead');
    }

    public function viewOwnOU(AuthUser $authUser, Lead $lead): bool
    {
        return $authUser->can('ViewOwnOU:Lead');
    }
    ...
    public function overrideApproval(AuthUser $authUser, Lead $lead): bool
    {
        return $authUser->can('OverrideApproval:Lead');
    }
