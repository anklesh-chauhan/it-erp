...
class PurchaseOrderPolicy
{
    ...
    public function viewOwnTerritory(AuthUser $authUser, PurchaseOrder $purchaseOrder): bool
    {
        return $authUser->can('ViewOwnTerritory:PurchaseOrder');
    }

    public function viewOwnOU(AuthUser $authUser, PurchaseOrder $purchaseOrder): bool
    {
        return $authUser->can('ViewOwnOU:PurchaseOrder');
    }

    public function viewOwn(AuthUser $authUser, PurchaseOrder $purchaseOrder): bool
    {
        return $authUser->can('ViewOwn:PurchaseOrder');
    }

    public function overrideApproval(AuthUser $authUser, PurchaseOrder $purchaseOrder): bool
    {
        return $authUser->can('OverrideApproval:PurchaseOrder');
    }
