...
class PackagingTypePolicy
{
     ...
     */
    public function view(User|TenantUser $user, PackagingType $packagingType): bool
    {
     ...
     */
    public function update(User|TenantUser $user, PackagingType $packagingType): bool
    {
     ...
     */
    public function delete(User|TenantUser $user, PackagingType $packagingType): bool
    {
     ...
     */
    public function forceDelete(User|TenantUser $user, PackagingType $packagingType): bool
    {
     ...
     */
    public function restore(User|TenantUser $user, PackagingType $packagingType): bool
    {
     ...
     */
    public function replicate(User|TenantUser $user, PackagingType $packagingType): bool
    {
