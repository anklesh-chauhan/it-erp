...
class TermsAndConditionPolicy
{
     ...
     */
    public function view(User|TenantUser $user, TermsAndCondition $termsAndCondition): bool
    {
     ...
     */
    public function update(User|TenantUser $user, TermsAndCondition $termsAndCondition): bool
    {
     ...
     */
    public function delete(User|TenantUser $user, TermsAndCondition $termsAndCondition): bool
    {
     ...
     */
    public function forceDelete(User|TenantUser $user, TermsAndCondition $termsAndCondition): bool
    {
     ...
     */
    public function restore(User|TenantUser $user, TermsAndCondition $termsAndCondition): bool
    {
     ...
     */
    public function replicate(User|TenantUser $user, TermsAndCondition $termsAndCondition): bool
    {
