...
class TypeMasterPolicy
{
     ...
     */
    public function view(User|TenantUser $user, TypeMaster $typeMaster): bool
    {
     ...
     */
    public function update(User|TenantUser $user, TypeMaster $typeMaster): bool
    {
     ...
     */
    public function delete(User|TenantUser $user, TypeMaster $typeMaster): bool
    {
     ...
     */
    public function forceDelete(User|TenantUser $user, TypeMaster $typeMaster): bool
    {
     ...
     */
    public function restore(User|TenantUser $user, TypeMaster $typeMaster): bool
    {
     ...
     */
    public function replicate(User|TenantUser $user, TypeMaster $typeMaster): bool
    {
