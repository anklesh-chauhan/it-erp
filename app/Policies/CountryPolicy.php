...
class CountryPolicy
{
     ...
     */
    public function view(User|TenantUser $user, Country $country): bool
    {
     ...
     */
    public function update(User|TenantUser $user, Country $country): bool
    {
     ...
     */
    public function delete(User|TenantUser $user, Country $country): bool
    {
     ...
     */
    public function forceDelete(User|TenantUser $user, Country $country): bool
    {
     ...
     */
    public function restore(User|TenantUser $user, Country $country): bool
    {
     ...
     */
    public function replicate(User|TenantUser $user, Country $country): bool
    {
