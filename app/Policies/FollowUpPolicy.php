...
class FollowUpPolicy
{
    ...
    public function viewOwnTerritory(AuthUser $authUser, FollowUp $followUp): bool
    {
        return $authUser->can('ViewOwnTerritory:FollowUp');
    }

    public function viewOwnOU(AuthUser $authUser, FollowUp $followUp): bool
    {
        return $authUser->can('ViewOwnOU:FollowUp');
    }
    ...
    public function overrideApproval(AuthUser $authUser, FollowUp $followUp): bool
    {
        return $authUser->can('OverrideApproval:FollowUp');
    }
