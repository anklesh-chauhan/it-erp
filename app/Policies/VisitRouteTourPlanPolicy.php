...
class VisitRouteTourPlanPolicy
{
     ...
     */
    public function view(User|TenantUser $user, VisitRouteTourPlan $visitRouteTourPlan): bool
    {
     ...
     */
    public function update(User|TenantUser $user, VisitRouteTourPlan $visitRouteTourPlan): bool
    {
     ...
     */
    public function delete(User|TenantUser $user, VisitRouteTourPlan $visitRouteTourPlan): bool
    {
     ...
     */
    public function forceDelete(User|TenantUser $user, VisitRouteTourPlan $visitRouteTourPlan): bool
    {
     ...
     */
    public function restore(User|TenantUser $user, VisitRouteTourPlan $visitRouteTourPlan): bool
    {
     ...
     */
    public function replicate(User|TenantUser $user, VisitRouteTourPlan $visitRouteTourPlan): bool
    {
