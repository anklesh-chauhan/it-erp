...
class CompanyMasterPolicy
{
     ...
     */
    public function view(User|TenantUser $user, CompanyMaster $companyMaster): bool
    {
     ...
     */
    public function update(User|TenantUser $user, CompanyMaster $companyMaster): bool
    {
     ...
     */
    public function delete(User|TenantUser $user, CompanyMaster $companyMaster): bool
    {
     ...
     */
    public function forceDelete(User|TenantUser $user, CompanyMaster $companyMaster): bool
    {
     ...
     */
    public function restore(User|TenantUser $user, CompanyMaster $companyMaster): bool
    {
     ...
     */
    public function replicate(User|TenantUser $user, CompanyMaster $companyMaster): bool
    {
