...
class SalesDcrPolicy
{
     ...
     */
    public function view(User|TenantUser $user, SalesDcr $salesDcr): bool
    {
     ...
     */
    public function update(User|TenantUser $user, SalesDcr $salesDcr): bool
    {
     ...
     */
    public function delete(User|TenantUser $user, SalesDcr $salesDcr): bool
    {
     ...
     */
    public function forceDelete(User|TenantUser $user, SalesDcr $salesDcr): bool
    {
     ...
     */
    public function restore(User|TenantUser $user, SalesDcr $salesDcr): bool
    {
     ...
     */
    public function replicate(User|TenantUser $user, SalesDcr $salesDcr): bool
    {
