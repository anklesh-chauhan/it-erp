...
class HolidayPolicy
{
    ...
    public function viewOwnTerritory(AuthUser $authUser, Holiday $holiday): bool
    {
        return $authUser->can('ViewOwnTerritory:Holiday');
    }

    public function viewOwnOU(AuthUser $authUser, Holiday $holiday): bool
    {
        return $authUser->can('ViewOwnOU:Holiday');
    }

    public function viewOwn(AuthUser $authUser, Holiday $holiday): bool
    {
        return $authUser->can('ViewOwn:Holiday');
    }

    public function overrideApproval(AuthUser $authUser, Holiday $holiday): bool
    {
        return $authUser->can('OverrideApproval:Holiday');
    }
