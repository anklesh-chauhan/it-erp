...
class ApprovalRulePolicy
{
    ...
    public function viewOwnTerritory(AuthUser $authUser, ApprovalRule $approvalRule): bool
    {
        return $authUser->can('ViewOwnTerritory:ApprovalRule');
    }

    public function viewOwnOU(AuthUser $authUser, ApprovalRule $approvalRule): bool
    {
        return $authUser->can('ViewOwnOU:ApprovalRule');
    }
    ...
    public function overrideApproval(AuthUser $authUser, ApprovalRule $approvalRule): bool
    {
        return $authUser->can('OverrideApproval:ApprovalRule');
    }
