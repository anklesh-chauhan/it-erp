...
class QuotePolicy
{
     ...
     */
    public function view(User|TenantUser $user, Quote $quote): bool
    {
     ...
     */
    public function update(User|TenantUser $user, Quote $quote): bool
    {
     ...
     */
    public function delete(User|TenantUser $user, Quote $quote): bool
    {
     ...
     */
    public function forceDelete(User|TenantUser $user, Quote $quote): bool
    {
     ...
     */
    public function restore(User|TenantUser $user, Quote $quote): bool
    {
     ...
     */
    public function replicate(User|TenantUser $user, Quote $quote): bool
    {
