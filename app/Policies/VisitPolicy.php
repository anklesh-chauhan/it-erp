...
class VisitPolicy
{
    ...
    public function viewOwnTerritory(AuthUser $authUser, Visit $visit): bool
    {
        return $authUser->can('ViewOwnTerritory:Visit');
    }

    public function viewOwnOU(AuthUser $authUser, Visit $visit): bool
    {
        return $authUser->can('ViewOwnOU:Visit');
    }

    public function viewOwn(AuthUser $authUser, Visit $visit): bool
    {
        return $authUser->can('ViewOwn:Visit');
    }

    public function overrideApproval(AuthUser $authUser, Visit $visit): bool
    {
        return $authUser->can('OverrideApproval:Visit');
    }
