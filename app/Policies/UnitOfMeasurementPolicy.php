...
class UnitOfMeasurementPolicy
{
     ...
     */
    public function view(User|TenantUser $user, UnitOfMeasurement $unitOfMeasurement): bool
    {
     ...
     */
    public function update(User|TenantUser $user, UnitOfMeasurement $unitOfMeasurement): bool
    {
     ...
     */
    public function delete(User|TenantUser $user, UnitOfMeasurement $unitOfMeasurement): bool
    {
     ...
     */
    public function forceDelete(User|TenantUser $user, UnitOfMeasurement $unitOfMeasurement): bool
    {
     ...
     */
    public function restore(User|TenantUser $user, UnitOfMeasurement $unitOfMeasurement): bool
    {
     ...
     */
    public function replicate(User|TenantUser $user, UnitOfMeasurement $unitOfMeasurement): bool
    {
