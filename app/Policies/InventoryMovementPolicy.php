...
class InventoryMovementPolicy
{
    ...
    public function viewOwnTerritory(AuthUser $authUser, InventoryMovement $inventoryMovement): bool
    {
        return $authUser->can('ViewOwnTerritory:InventoryMovement');
    }

    public function viewOwnOU(AuthUser $authUser, InventoryMovement $inventoryMovement): bool
    {
        return $authUser->can('ViewOwnOU:InventoryMovement');
    }

    public function viewOwn(AuthUser $authUser, InventoryMovement $inventoryMovement): bool
    {
        return $authUser->can('ViewOwn:InventoryMovement');
    }

    public function overrideApproval(AuthUser $authUser, InventoryMovement $inventoryMovement): bool
    {
        return $authUser->can('OverrideApproval:InventoryMovement');
    }
