...
class FollowUpStatusPolicy
{
     ...
     */
    public function view(User|TenantUser $user, FollowUpStatus $followUpStatus): bool
    {
     ...
     */
    public function update(User|TenantUser $user, FollowUpStatus $followUpStatus): bool
    {
     ...
     */
    public function delete(User|TenantUser $user, FollowUpStatus $followUpStatus): bool
    {
     ...
     */
    public function forceDelete(User|TenantUser $user, FollowUpStatus $followUpStatus): bool
    {
     ...
     */
    public function restore(User|TenantUser $user, FollowUpStatus $followUpStatus): bool
    {
     ...
     */
    public function replicate(User|TenantUser $user, FollowUpStatus $followUpStatus): bool
    {
