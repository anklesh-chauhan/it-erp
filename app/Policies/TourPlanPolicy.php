...
class TourPlanPolicy
{
     ...
     */
    public function view(User|TenantUser $user, TourPlan $tourPlan): bool
    {
     ...
     */
    public function update(User|TenantUser $user, TourPlan $tourPlan): bool
    {
     ...
     */
    public function delete(User|TenantUser $user, TourPlan $tourPlan): bool
    {
     ...
     */
    public function forceDelete(User|TenantUser $user, TourPlan $tourPlan): bool
    {
     ...
     */
    public function restore(User|TenantUser $user, TourPlan $tourPlan): bool
    {
     ...
     */
    public function replicate(User|TenantUser $user, TourPlan $tourPlan): bool
    {
