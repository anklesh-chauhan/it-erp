...
class CompanyMasterStatutoryDetailPolicy
{
     ...
     */
    public function view(User|TenantUser $user, CompanyMasterStatutoryDetail $companyMasterStatutoryDetail): bool
    {
     ...
     */
    public function update(User|TenantUser $user, CompanyMasterStatutoryDetail $companyMasterStatutoryDetail): bool
    {
     ...
     */
    public function delete(User|TenantUser $user, CompanyMasterStatutoryDetail $companyMasterStatutoryDetail): bool
    {
     ...
     */
    public function forceDelete(User|TenantUser $user, CompanyMasterStatutoryDetail $companyMasterStatutoryDetail): bool
    {
     ...
     */
    public function restore(User|TenantUser $user, CompanyMasterStatutoryDetail $companyMasterStatutoryDetail): bool
    {
     ...
     */
    public function replicate(User|TenantUser $user, CompanyMasterStatutoryDetail $companyMasterStatutoryDetail): bool
    {
