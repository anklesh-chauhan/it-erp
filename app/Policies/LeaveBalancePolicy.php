...
class LeaveBalancePolicy
{
    ...
    public function viewOwnTerritory(AuthUser $authUser, LeaveBalance $leaveBalance): bool
    {
        return $authUser->can('ViewOwnTerritory:LeaveBalance');
    }

    public function viewOwnOU(AuthUser $authUser, LeaveBalance $leaveBalance): bool
    {
        return $authUser->can('ViewOwnOU:LeaveBalance');
    }

    public function viewOwn(AuthUser $authUser, LeaveBalance $leaveBalance): bool
    {
