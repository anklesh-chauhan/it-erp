...
class NumberSeriesPolicy
{
     ...
     */
    public function view(User|TenantUser $user, NumberSeries $numberSeries): bool
    {
     ...
     */
    public function update(User|TenantUser $user, NumberSeries $numberSeries): bool
    {
     ...
     */
    public function delete(User|TenantUser $user, NumberSeries $numberSeries): bool
    {
     ...
     */
    public function forceDelete(User|TenantUser $user, NumberSeries $numberSeries): bool
    {
     ...
     */
    public function restore(User|TenantUser $user, NumberSeries $numberSeries): bool
    {
     ...
     */
    public function replicate(User|TenantUser $user, NumberSeries $numberSeries): bool
    {
