...
class LeadActivityPolicy
{
     ...
     */
    public function view(User|TenantUser $user, LeadActivity $leadActivity): bool
    {
     ...
     */
    public function update(User|TenantUser $user, LeadActivity $leadActivity): bool
    {
     ...
     */
    public function delete(User|TenantUser $user, LeadActivity $leadActivity): bool
    {
     ...
     */
    public function forceDelete(User|TenantUser $user, LeadActivity $leadActivity): bool
    {
     ...
     */
    public function restore(User|TenantUser $user, LeadActivity $leadActivity): bool
    {
     ...
     */
    public function replicate(User|TenantUser $user, LeadActivity $leadActivity): bool
    {
