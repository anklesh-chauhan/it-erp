...
class CompanyPolicy
{
     ...
     */
    public function view(User|TenantUser $user, Company $company): bool
    {
     ...
     */
    public function update(User|TenantUser $user, Company $company): bool
    {
     ...
     */
    public function delete(User|TenantUser $user, Company $company): bool
    {
     ...
     */
    public function forceDelete(User|TenantUser $user, Company $company): bool
    {
     ...
     */
    public function restore(User|TenantUser $user, Company $company): bool
    {
     ...
     */
    public function replicate(User|TenantUser $user, Company $company): bool
    {
