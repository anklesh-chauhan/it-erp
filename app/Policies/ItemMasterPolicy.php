...
class ItemMasterPolicy
{
     ...
     */
    public function view(User|TenantUser $user, ItemMaster $itemMaster): bool
    {
     ...
     */
    public function update(User|TenantUser $user, ItemMaster $itemMaster): bool
    {
     ...
     */
    public function delete(User|TenantUser $user, ItemMaster $itemMaster): bool
    {
     ...
     */
    public function forceDelete(User|TenantUser $user, ItemMaster $itemMaster): bool
    {
     ...
     */
    public function restore(User|TenantUser $user, ItemMaster $itemMaster): bool
    {
     ...
     */
    public function replicate(User|TenantUser $user, ItemMaster $itemMaster): bool
    {
