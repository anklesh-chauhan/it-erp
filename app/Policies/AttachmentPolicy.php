...
class AttachmentPolicy
{
     ...
     */
    public function view(User|TenantUser $user, Attachment $attachment): bool
    {
     ...
     */
    public function update(User|TenantUser $user, Attachment $attachment): bool
    {
     ...
     */
    public function delete(User|TenantUser $user, Attachment $attachment): bool
    {
     ...
     */
    public function forceDelete(User|TenantUser $user, Attachment $attachment): bool
    {
     ...
     */
    public function restore(User|TenantUser $user, Attachment $attachment): bool
    {
     ...
     */
    public function replicate(User|TenantUser $user, Attachment $attachment): bool
    {
