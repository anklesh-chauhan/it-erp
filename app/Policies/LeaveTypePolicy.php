...
class LeaveTypePolicy
{
    ...
    public function viewOwnTerritory(AuthUser $authUser, LeaveType $leaveType): bool
    {
        return $authUser->can('ViewOwnTerritory:LeaveType');
    }

    public function viewOwnOU(AuthUser $authUser, LeaveType $leaveType): bool
    {
        return $authUser->can('ViewOwnOU:LeaveType');
    }

    public function viewOwn(AuthUser $authUser, LeaveType $leaveType): bool
    {
