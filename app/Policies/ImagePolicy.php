...
class ImagePolicy
{
     ...
     */
    public function view(User|TenantUser $user, Image $image): bool
    {
     ...
     */
    public function update(User|TenantUser $user, Image $image): bool
    {
     ...
     */
    public function delete(User|TenantUser $user, Image $image): bool
    {
     ...
     */
    public function forceDelete(User|TenantUser $user, Image $image): bool
    {
     ...
     */
    public function restore(User|TenantUser $user, Image $image): bool
    {
     ...
     */
    public function replicate(User|TenantUser $user, Image $image): bool
    {
