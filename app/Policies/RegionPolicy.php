...
class RegionPolicy
{
     ...
     */
    public function view(User|TenantUser $user, Region $region): bool
    {
     ...
     */
    public function update(User|TenantUser $user, Region $region): bool
    {
     ...
     */
    public function delete(User|TenantUser $user, Region $region): bool
    {
     ...
     */
    public function forceDelete(User|TenantUser $user, Region $region): bool
    {
     ...
     */
    public function restore(User|TenantUser $user, Region $region): bool
    {
     ...
     */
    public function replicate(User|TenantUser $user, Region $region): bool
    {
