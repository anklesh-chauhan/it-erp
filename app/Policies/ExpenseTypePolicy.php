...
class ExpenseTypePolicy
{
     ...
     */
    public function view(User|TenantUser $user, ExpenseType $expenseType): bool
    {
     ...
     */
    public function update(User|TenantUser $user, ExpenseType $expenseType): bool
    {
     ...
     */
    public function delete(User|TenantUser $user, ExpenseType $expenseType): bool
    {
     ...
     */
    public function forceDelete(User|TenantUser $user, ExpenseType $expenseType): bool
    {
     ...
     */
    public function restore(User|TenantUser $user, ExpenseType $expenseType): bool
    {
     ...
     */
    public function replicate(User|TenantUser $user, ExpenseType $expenseType): bool
    {
