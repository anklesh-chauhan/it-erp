...
class AreaTownRelationManager extends RelationManager
{
    protected static string $relationship = 'areaTowns';

    public function form(Schema $schema): Schema
    {
        return $schema
            ->components([
                TextInput::make('areaTowns')
                    ->required()
                    ->maxLength(255),
            ]);
    }
    ...
    {
        return $table
            ->recordTitleAttribute('areaTowns')
            ->columns([
